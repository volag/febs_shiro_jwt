...
public class CacheServiceImpl implements CacheService {
    ...
    @Override
    public String getCode(String tel) throws Exception {
        String telString = this.redisService.get(FebsConstant.USER_CACHE_CODE_PREFIX + tel);
        if (StringUtils.isBlank(telString))
            throw new Exception();
        else
            return telString;
    }
    ...
    public User getUserByMobile(String mobile) throws Exception {
        String mobileString = this.redisService.get(FebsConstant.USER_CACHE_PREFIX + mobile);
        if (StringUtils.isBlank(mobileString))
            throw new Exception();
        else
            return this.mapper.readValue(mobileString, User.class);
    }
    ...
    @Override
    public void saveCode(String tel,String code) throws Exception {
        this.deleteCode(tel);
        redisService.set(FebsConstant.USER_CACHE_CODE_PREFIX + tel, mapper.writeValueAsString(code));
    }
    ...
    @Override
    public void deleteCode(String tel) throws Exception {
        tel = tel.toLowerCase();
        redisService.del(FebsConstant.USER_CACHE_CODE_PREFIX + tel);
    }
