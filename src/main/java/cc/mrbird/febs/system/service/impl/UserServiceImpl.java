...
//        return baseMapper.selectOne(new LambdaQueryWrapper<User>().eq(User::getUsername, username));
    ...
    @Override
    @Transactional
    public void updateResume(String username, String resume) throws Exception {
        User user = new User();
    ...
    @Override
    @Transactional
    public void regist(String username, String password,String tel) throws Exception {
        User user = new User();
        user.setMobile(tel);
        user.setPassword(MD5Util.encrypt(username, password));
        ...
        resume.setPhoto(Resume.DEFAULT_AVATAR);
